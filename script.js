    ...
    if (task.complated == false) {
      document.getElementById("myul").innerHTML += `
       <div class="row">
                ...
                <div class="col-6 ">
                    <div onclick="clickcheck(${task.get(
                      "id"
                    )})" class="btn text-white bg-success"><i class="fa-solid fa-check "></i></div>
                    <div onclick="clickedit(${task.get(
                      "id"
                    )})" class="btn text-white bg-primary"><i class="fa-solid fa-pen "></i></div>
                    <div onclick="clickdell(${task.get(
                      "id"
                    )})" class="btn text-white bg-danger "><i  class="fa-solid fa-trash " ></i></div>
                </div>
            </div>
                         `;
      ...
      document.getElementById("mycom").innerHTML += `
       <div class="row">
                <div class="col-6 ">
                    <ul>
                        <li class="list-group-item">
                            <label class="text-decoration-line-through" for="">${task.get(
                              "description"
                            )}</label>
                        </li>
                    </ul>
                ...
                <div class="col-6 ">
                    <button  disabled onclick="clickcheck()" class="btn text-white bg-success"><i class="fa-solid fa-check "></i></button>
